...
def read_first_sheet(path: str | Path) -> list[list[str]]:
    ...
    for row_node in sheet.iter():
        ...
        if max_index >= 0:
            rows.append(
                [row_values.get(index, "") for index in range(max_index + 1)]
            )
...
def write_workbook(
    path: str | Path, sheets: list[tuple[str, list[list[object]]]]
) -> None:
    if not sheets:
    ...
    content_types = [
        ...
        'ContentType="application/vnd.openxmlformats-officedocument.spreadshee'
        'tml.sheet.main+xml"/>',
        '<Override PartName="/xl/styles.xml" '
        'ContentType="application/vnd.openxmlformats-officedocument.spreadshee'
        'tml.styles+xml"/>',
        '<Override PartName="/docProps/core.xml" '
        'ContentType="application/vnd.openxmlformats-package.core-properties+x'
        'ml"/>',
        '<Override PartName="/docProps/app.xml" '
        'ContentType="application/vnd.openxmlformats-officedocument.extended-p'
        'roperties+xml"/>',
    ]
    ...
    for sheet_index, (sheet_name, _rows) in enumerate(sheets, start=1):
        ...
        workbook_sheets.append(
            f'<sheet name="{sheet_safe_name}" sheetId="{sheet_index}" '
            f'r:id="rId{sheet_index}"/>'
        )
        workbook_rels.append(
            f'<Relationship Id="rId{sheet_index}" '
            'Type="http://schemas.openxmlformats.org/officeDocument/2006/relat'
            'ionships/worksheet" '
            f'Target="worksheets/sheet{sheet_index}.xml"/>'
        )
        content_types.append(
            f'<Override PartName="/xl/worksheets/sheet{sheet_index}.xml" '
            'ContentType="application/vnd.openxmlformats-officedocument.spread'
            'sheetml.worksheet+xml"/>'
        )
    ...
    with ZipFile(path, "w", ZIP_DEFLATED) as zip_file:
        zip_file.writestr(
            ...
            (
                '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'
                '<Relationships '
                'xmlns="http://schemas.openxmlformats.org/package/2006/relatio'
                'nships">'
                '<Relationship Id="rId1" '
                'Type="http://schemas.openxmlformats.org/officeDocument/2006/r'
                'elationships/officeDocument" '
                'Target="xl/workbook.xml"/>'
                '<Relationship Id="rId2" '
                'Type="http://schemas.openxmlformats.org/package/2006/relation'
                'ships/metadata/core-properties" '
                'Target="docProps/core.xml"/>'
                '<Relationship Id="rId3" '
                'Type="http://schemas.openxmlformats.org/officeDocument/2006/r'
                'elationships/extended-properties" '
        ...
        zip_file.writestr(
            ...
            (
                ...
                'ain" '
                'xmlns:r="http://schemas.openxmlformats.org/officeDocument/200'
                '6/relationships">'
        ...
        zip_file.writestr(
            ...
            (
                ...
                'xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/m'
                'ain">'
                '<fonts count="1"><font><sz val="11"/><name '
                'val="Calibri"/></font></fonts>'
                '<fills count="2">'
                ...
                '<cellStyles count="1"><cellStyle name="Normale" xfId="0" '
        ...
        zip_file.writestr(
            ...
            (
                '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'
                '<cp:coreProperties '
                'xmlns:cp="http://schemas.openxmlformats.org/package/2006/meta'
                ...
                f'<dcterms:created '
                f'xsi:type="dcterms:W3CDTF">{created}</dcterms:created>'
                f'<dcterms:modified '
                f'xsi:type="dcterms:W3CDTF">{created}</dcterms:modified>'
                "</cp:coreProperties>"
            ),
        )
        zip_file.writestr(
            ...
            (
                ...
                'extended-properties" '
                'xmlns:vt="http://schemas.openxmlformats.org/officeDocument/20'
                '06/docPropsVTypes">'
        ...
        zip_file.writestr(
            ...
            (
                ...
                'ContentType="application/vnd.openxmlformats-package.relations'
                'hips+xml"/>'
